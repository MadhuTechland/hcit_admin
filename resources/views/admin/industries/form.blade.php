<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Industry Details</h5>
            </div>
            <div class="card-body">
                <!-- Title -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              placeholder="Brief description shown in navigation dropdown" required>{{ old('description', $industry->description ?? '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tags') is-invalid @enderror"
                           id="tags" name="tags" value="{{ old('tags', $industry->tags ?? '') }}"
                           placeholder="e.g., Artificial, Technology, Machine (comma-separated)">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('breadcrumb_title') is-invalid @enderror"
                           ...
                           value="{{ old('breadcrumb_title', $industry->breadcrumb_title ?? '') }}"
                           placeholder="e.g., Retail & CPG">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('subtitle') is-invalid @enderror"
                           id="subtitle" name="subtitle" value="{{ old('subtitle', $industry->subtitle ?? '') }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('detail_title') is-invalid @enderror"
                              ...
                              placeholder="Main heading on detail page">{{ old('detail_title', $industry->detail_title ?? '') }}</textarea>
                    @error('detail_title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('detail_description') is-invalid @enderror"
                              ...
                              placeholder="Paragraph below the main title">{{ old('detail_description', $industry->detail_description ?? '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('content') is-invalid @enderror"
                              ...
                              placeholder="Full HTML content for the detail page...">{{ old('content', $industry->content ?? '') }}</textarea>
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('order') is-invalid @enderror"
                           id="order" name="order" value="{{ old('order', $industry->order ?? 0) }}"
                           placeholder="0">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> {{ isset($industry) ? 'Update Industry' : 'Create Industry' }}
                    </button>
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h5 class="card-title mb-0">Industry Image (Navigation)</h5>
            </div>
            <div class="card-body">
                <div class="mb-3">
