...
@section('page-title', 'Service Sections - ' . $service->title)
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Sections for {{ $service->title }}</h4>
                        ...
                        <tbody>
                            @forelse($sections as $section)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.services.sections.edit', [$service, $section]) }}" class="btn btn-sm btn-primary">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="{{ route('admin.services.sections.destroy', [$service, $section]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this section?');">
                                                @csrf
                                                @method('DELETE')
