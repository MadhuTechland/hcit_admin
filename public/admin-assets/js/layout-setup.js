...
// Apply each setting from sessionStorage or use default
settings.forEach((setting) => {
    const savedValue = sessionStorage.getItem(setting.attribute);
...
if ((document.documentElement.getAttribute("data-layout") === "vertical" || document.documentElement.getAttribute("data-layout") === "horizontal") && document.documentElement.getAttribute("data-sidebar") !== "icon") {
...
// Function to set an attribute and save to sessionStorage
...
function handleSidebarToggle() {
    ...
    if (window.innerWidth < 992) {
        ...
        if (currentToggled === "icon") {
            ...
            sessionStorage.setItem("data-sidebar", "default");
        } else {
            htmlElement.setAttribute("data-sidebar", "icon");
            sessionStorage.setItem("data-sidebar", "icon");
